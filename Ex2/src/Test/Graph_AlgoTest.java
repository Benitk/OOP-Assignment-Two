...
class Graph_AlgoTest {
	...
	private static final DGraph dg=new DGraph();
	 ...
	 static Point3D p6=new Point3D(20,14);
	 ...
	 static nodeData nd6 = new nodeData(p6);
	...
	void testShortestPathDist() {
		Graph_Algo ga= new Graph_Algo();
		ga.init(dg);
		assertEquals(ga.shortestPathDist(1,6),2.7);
	}
	...
	void testShortestPath() {
		...
		arr=(ArrayList<node_data>) ga.shortestPath(1,6);
